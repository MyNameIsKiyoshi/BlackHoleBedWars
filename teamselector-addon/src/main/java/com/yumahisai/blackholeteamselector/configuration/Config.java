package com.yumahisai.blackholeteamselector.configuration;
...
public class Config {
    ...
    public static void addDefaultConfig() {
        ...
        new File("plugins/BlackHoleBedWars/Addons/BlackHoleTeamSelector").mkdirs();

        config = new ConfigManager(Main.plugin, "config", "plugins/BlackHoleBedWars/Addons/BlackHoleTeamSelector");
        YamlConfiguration yml = config.getYml();
        yml.options().header("Team Selector Add-on for BlackHoleBedWars Mini-game.\n\nDocumentation:\n" +
